               ...
               <div class="col-md-9"><!-- col-md-9 Open -->
                   <div class="box"><!-- box Open -->
                       <div class="box-header"><!-- box-header Open -->
                           ...
                           <form action="customer_register.php" method="post" enctype="multipart/form-data"><!-- form Open -->
                               ...
                               <div class="text-center"><!-- text-center Open -->
                                   <button type="submit" name="register" class="btn btn-primary"><i class="fa fa-user"></i> Register </button>
